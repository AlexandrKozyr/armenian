...
<div class="main album">
    <div class="breadcrumbs">
        ...
        <a class="active" href="<?php echo url_for('@fotoalbum-show?id=' . $currentAlbum->getId()) ?>">Фотоальбом &#171;<?php echo $currentAlbum->getTitle() ?>&#187;</a>
    </div>
    <h2>Фотоальбом &#171;<?php echo $currentAlbum->getTitle() ?>&#187;</h2>
    <div class="item">
        <span class="date"><?php echo substr($currentAlbum->getCreatedAt(), 0, 10) ?></span>
        <span class="time"><?php echo substr($currentAlbum->getCreatedAt(), 11, 5) ?></span>
    </div>
                            ...
                            <li>
                                <div class="carousel_div">
                                    <?php if (is_string($img[1])): ?>
                                        <?php echo $img[1] ?>
                                    <?php else: ?>
                                        <?php echo 'Изображение ' . $currentAlbum->getTitle() ?>
                                    <?php endif ?>
                                </div> 
