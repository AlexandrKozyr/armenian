...
abstract class BaseVideo extends BaseObject  implements Persistent {
	...
	public function setContent($v)
	{
		...
		if ($this->content !== $v) {
			$this->content = $v;
			$this->modifiedColumns[] = VideoPeer::CONTENT;
		}
	...
	public function setMetaDescription($v)
	{
		...
		if ($this->meta_description !== $v) {
			...
			$this->modifiedColumns[] = VideoPeer::META_DESCRIPTION;
		}
	...
	public function setMetaKeywords($v)
	{
		...
		if ($this->meta_keywords !== $v) {
			...
			$this->modifiedColumns[] = VideoPeer::META_KEYWORDS;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(VideoPeer::CONTENT)) $criteria->add(VideoPeer::CONTENT, $this->content);
		...
		if ($this->isColumnModified(VideoPeer::META_DESCRIPTION)) $criteria->add(VideoPeer::META_DESCRIPTION, $this->meta_description);
		if ($this->isColumnModified(VideoPeer::META_KEYWORDS)) $criteria->add(VideoPeer::META_KEYWORDS, $this->meta_keywords);
