...
abstract class BaseNews extends BaseObject  implements Persistent {
	...
	public function setMetaDescription($v)
	{
		...
		if ($this->meta_description !== $v) {
			...
			$this->modifiedColumns[] = NewsPeer::META_DESCRIPTION;
		}
	...
	public function setMetaKeywords($v)
	{
		...
		if ($this->meta_keywords !== $v) {
			...
			$this->modifiedColumns[] = NewsPeer::META_KEYWORDS;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NewsPeer::META_DESCRIPTION)) $criteria->add(NewsPeer::META_DESCRIPTION, $this->meta_description);
		if ($this->isColumnModified(NewsPeer::META_KEYWORDS)) $criteria->add(NewsPeer::META_KEYWORDS, $this->meta_keywords);
