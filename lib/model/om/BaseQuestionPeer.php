...
abstract class BaseQuestionPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Fio', 'Email', 'Phone', 'Message', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'fio', 'email', 'phone', 'message', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::FIO, self::EMAIL, self::PHONE, self::MESSAGE, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'FIO', 'email', 'phone', 'message', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Fio' => 1, 'Email' => 2, 'Phone' => 3, 'Message' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'fio' => 1, 'email' => 2, 'phone' => 3, 'message' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::FIO => 1, self::EMAIL => 2, self::PHONE => 3, self::MESSAGE => 4, self::CREATED_AT => 5, self::UPDATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'FIO' => 1, 'email' => 2, 'phone' => 3, 'message' => 4, 'created_at' => 5, 'updated_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(QuestionPeer::FIO);
		$criteria->addSelectColumn(QuestionPeer::EMAIL);
		$criteria->addSelectColumn(QuestionPeer::PHONE);
		$criteria->addSelectColumn(QuestionPeer::MESSAGE);
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseQuestionPeer', $criteria, $con);
		}
	...
	/**
	 * Method to invalidate the instance pool of all tables related to question
	...
	{
		return $withPrefix ? QuestionPeer::CLASS_DEFAULT : QuestionPeer::OM_CLASS;
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseQuestionPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseQuestionPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseQuestionPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseQuestionPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseQuestionPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseQuestionPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseQuestionPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseQuestionPeer', $values, $con, $ret);
    }
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseQuestionPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
