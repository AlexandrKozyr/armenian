...
abstract class BaseUser extends BaseObject  implements Persistent {
	...
	public function setCreateAt($v)
	{
		...
		if ( $this->create_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = UserPeer::CREATE_AT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->create_at = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setCreateAt($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserPeer::CREATE_AT)) $criteria->add(UserPeer::CREATE_AT, $this->create_at);
