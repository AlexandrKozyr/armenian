...
abstract class BaseNewsPeer {
	...
	const META_DESCRIPTION = 'news.META_DESCRIPTION';

	/** the column name for the META_KEYWORDS field */
	const META_KEYWORDS = 'news.META_KEYWORDS';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ImageId', 'Title', 'Content', 'CreatedAt', 'UpdatedAt', 'MetaDescription', 'MetaKeywords', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'imageId', 'title', 'content', 'createdAt', 'updatedAt', 'metaDescription', 'metaKeywords', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::IMAGE_ID, self::TITLE, self::CONTENT, self::CREATED_AT, self::UPDATED_AT, self::META_DESCRIPTION, self::META_KEYWORDS, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'image_id', 'title', 'content', 'created_at', 'updated_at', 'meta_description', 'meta_keywords', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ImageId' => 1, 'Title' => 2, 'Content' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, 'MetaDescription' => 6, 'MetaKeywords' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'imageId' => 1, 'title' => 2, 'content' => 3, 'createdAt' => 4, 'updatedAt' => 5, 'metaDescription' => 6, 'metaKeywords' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::IMAGE_ID => 1, self::TITLE => 2, self::CONTENT => 3, self::CREATED_AT => 4, self::UPDATED_AT => 5, self::META_DESCRIPTION => 6, self::META_KEYWORDS => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'image_id' => 1, 'title' => 2, 'content' => 3, 'created_at' => 4, 'updated_at' => 5, 'meta_description' => 6, 'meta_keywords' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(NewsPeer::META_DESCRIPTION);
		$criteria->addSelectColumn(NewsPeer::META_KEYWORDS);
	}
	...
	public static function doCountJoinImage(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(NewsPeer::IMAGE_ID, ImagePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of News objects pre-filled with their Image objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinImage(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (News) to $obj2 (Image)
				$obj2->addNews($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (News) to the collection in $obj2 (Image)
				$obj2->addNews($obj1);
