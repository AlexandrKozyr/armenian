...
abstract class BaseVideoPeer {
	...
	const META_DESCRIPTION = 'video.META_DESCRIPTION';

	/** the column name for the META_KEYWORDS field */
	const META_KEYWORDS = 'video.META_KEYWORDS';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Content', 'Description', 'CreatedAt', 'UpdatedAt', 'MetaDescription', 'MetaKeywords', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'content', 'description', 'createdAt', 'updatedAt', 'metaDescription', 'metaKeywords', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TITLE, self::CONTENT, self::DESCRIPTION, self::CREATED_AT, self::UPDATED_AT, self::META_DESCRIPTION, self::META_KEYWORDS, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'content', 'description', 'created_at', 'updated_at', 'meta_description', 'meta_keywords', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Content' => 2, 'Description' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, 'MetaDescription' => 6, 'MetaKeywords' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'content' => 2, 'description' => 3, 'createdAt' => 4, 'updatedAt' => 5, 'metaDescription' => 6, 'metaKeywords' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TITLE => 1, self::CONTENT => 2, self::DESCRIPTION => 3, self::CREATED_AT => 4, self::UPDATED_AT => 5, self::META_DESCRIPTION => 6, self::META_KEYWORDS => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'content' => 2, 'description' => 3, 'created_at' => 4, 'updated_at' => 5, 'meta_description' => 6, 'meta_keywords' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(VideoPeer::CONTENT);
		...
		$criteria->addSelectColumn(VideoPeer::META_DESCRIPTION);
		$criteria->addSelectColumn(VideoPeer::META_KEYWORDS);
	}
