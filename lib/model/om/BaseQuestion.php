...
abstract class BaseQuestion extends BaseObject  implements Persistent {
	...
	public function setFio($v)
	{
		...
		if ($this->fio !== $v) {
			$this->fio = $v;
			$this->modifiedColumns[] = QuestionPeer::FIO;
		}
	...
	public function setEmail($v)
	{
		...
		if ($this->email !== $v) {
			$this->email = $v;
			$this->modifiedColumns[] = QuestionPeer::EMAIL;
		}
	...
	public function setPhone($v)
	{
		...
		if ($this->phone !== $v) {
			$this->phone = $v;
			$this->modifiedColumns[] = QuestionPeer::PHONE;
		}
	...
	public function setMessage($v)
	{
		...
		if ($this->message !== $v) {
			$this->message = $v;
			$this->modifiedColumns[] = QuestionPeer::MESSAGE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = QuestionPeer::NUM_COLUMNS - QuestionPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(QuestionPeer::FIO)) $criteria->add(QuestionPeer::FIO, $this->fio);
		if ($this->isColumnModified(QuestionPeer::EMAIL)) $criteria->add(QuestionPeer::EMAIL, $this->email);
		if ($this->isColumnModified(QuestionPeer::PHONE)) $criteria->add(QuestionPeer::PHONE, $this->phone);
		if ($this->isColumnModified(QuestionPeer::MESSAGE)) $criteria->add(QuestionPeer::MESSAGE, $this->message);
