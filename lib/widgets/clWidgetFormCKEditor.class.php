...
require_once sfConfig::get('sf_web_dir') . '/bend/js/ckeditor/ckeditor.php';
require_once sfConfig::get('sf_web_dir') . '/bend/js/ckfinder/ckfinder.php';

class clWidgetFormCKEditor extends sfWidgetFormTextarea {
    ...
    protected function configure($options = array(), $attributes = array()) {
        ...
        if (sfConfig::get('app_ckfinder_active', false) == 'true') {
            ...
            $this->_finder->SetupCKEditor($this->_editor, sfConfig::get('app_ckfinder_basePath'));
        }
